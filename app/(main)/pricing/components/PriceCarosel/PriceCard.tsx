...
//           <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-red-500 lg:text-base text-lg px-4 py-1 rounded-full font-bold whitespace-nowrap">
//             SAVE {discountAmount}%
//           </div>
//         )}
...
//             <sup className="text-sm capitalize">per video</sup>
//           </div>
//         </div>

//         <p className="text-sm text-gray-500">{desc} <span className="text-sm capitalize">per month</span></p>
